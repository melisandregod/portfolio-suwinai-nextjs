  ...
  return (
    <div className="m-4 overflow-hidden" id="Experience">
      <div className="flex flex-col items-center gap-10 my-10">
        <h2 className="text-3xl lg:text-5xl font-bold mt-2 xl:mt-20" data-aos="zoom-in">
          {title("title")}
        </h2>
        <div className="xl:flex flex-col justify-center xl:px-40">
          <div className="w-full flex flex-col h-full my-15 xl:my-30 justify-center">
            <div
              className="absolute bg-white h-[55vh] w-2.5 z-[-1] rounded-2xl ml-21 drop-shadow-md drop-shadow-white"
              data-aos="fade-up"
            ...
            {list.map((key, i) => (
              <div key={i} className="flex items-center">
                <Image
                  ...
                  width={600}
                  height={400}
                  className="w-[100] my-10 ml-10 mr-5 rounded-full border-white border-4 drop-shadow-md drop-shadow-white"
                  data-aos="zoom-in"
                  data-aos-delay="500"
                />
                <div className="mr-5" data-aos="fade-left" data-aos-delay="500">
                  ...
                  <p className="hidden 2xl:flex text-sm ">{t(`${key}.description`)}</p>
                </div>
              </div>
            ))}
          </div>
